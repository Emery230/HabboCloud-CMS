    ...
    <body>
							...
							<div class="col-md-6">
								<div class="hc_panel">
							   		<div class="hc_panel_title_sondage">
										<i class="fa fa-star"></i> Devenir VIP - 1 Mois
									</div>
									<div class="hc_panel_body">
										<div class="hc_panel_bloc">
											<div class="hc_panel_info">
												...
												<center>
													<strong><i style="color: green" class="fa fa-check"></i> 2 secondes d'attente sur la Shoutbox</strong><br>
													<strong><i style="color: green" class="fa fa-check"></i> 1 concours par semaine pour gagner un rétro</strong><br>
													<strong><i style="color: green" class="fa fa-check"></i> Prioritaire sur les livraison et sur le support</strong><br>
													<strong><i style="color: green" class="fa fa-check"></i> Une nouvelle couleur : <span class="colorPremium"><?= $_SESSION['account']['username']; ?></span></strong><br>
													<strong><i style="color: green" class="fa fa-check"></i> Possibilité d'ajouter des stories</strong><br>
													<strong><i style="color: green" class="fa fa-check"></i> Accès au futur nouveautés</strong><br>
													<strong><i style="color: green" class="fa fa-check"></i> Pour seulement 500 Points/mois</strong><br><br>
													<button id="a_vip1m" class="btn btn-primary btn-block">J'adhère</button>
												</center>
												<?php } elseif($_SESSION['account']['rank'] == 2) { ?>
												<center>Vous êtes déjà VIP</center>
												<?php } elseif($_SESSION['account']['rank'] == 3 OR $_SESSION['account']['rank'] == 4 OR $_SESSION['account']['rank'] == 5 OR $_SESSION['account']['rank'] == 6 OR $_SESSION['account']['rank'] == 8) { ?>
												<center>va ntm fdp t déjà staff tu veux quoi d'plus</center>
												<?php } elseif($_SESSION['account']['rank'] == 7) { ?>
												<center>Oh grand Dieu Profesor</center>
												<?php } ?>
											</div>
										</div>
								   </div>
								...
								<div class="hc_panel">
							   		<div class="hc_panel_title_sondage">
										<i class="fa fa-star"></i> Devenir VIP - À vie
									</div>
									<div class="hc_panel_body">
										<div class="hc_panel_bloc">
											<div class="hc_panel_info">
												...
												<center>
													...
													<strong><i style="color: green" class="fa fa-check"></i> Possibilité d'ajouter des stories</strong><br>
													<strong><i style="color: green" class="fa fa-check"></i> Accès au futur nouveautés</strong><br>
													<strong><i style="color: green" class="fa fa-check"></i> Pour seulement 1500 Points</strong><br><br>
													<button id="a_viplife" class="btn btn-primary btn-block">J'adhère</button>
												</center>
												<?php } elseif($_SESSION['account']['rank'] == 2) { ?>
												<center>Vous êtes déjà VIP</center>
												<?php } elseif($_SESSION['account']['rank'] == 3 OR $_SESSION['account']['rank'] == 4 OR $_SESSION['account']['rank'] == 5 OR $_SESSION['account']['rank'] == 6 OR $_SESSION['account']['rank'] == 8) { ?>
		...
		<script src="<?= $this->App('url'); ?>/app/ajax/notifications.js"></script>
			...
			$(document).ready(function() {
			 $('#a_vip1m').on('click', function(e) {
				 e.preventDefault();
				 
				 $.ajax({
					 url: '/system/ajax/vip_1m',
					 type: "POST",             
					 ...
					 {
						 if(data == 'success') {
							 $('#error').html('<div class="col-md-12"><div class="alert bg-success">Vous êtes maintenant VIP</div></div>');
							 window.setTimeout(function() {
								 window.location = json.url;
							 }, 1500);
						 } else {
							 $('#error').html('<div class="col-md-12"><div class="alert bg-danger">'+data+'</div></div>');
						 }
					 }
				 });
			 });
				...
				$(document).ready(function() {
			 $('#a_viplife').on('click', function(e) {
				 e.preventDefault();
				 
				 $.ajax({
					 url: '/system/ajax/vip_life',
					 type: "POST",             
					 data: new FormData(this),
					 contentType: false,      
					 cache: false,             
