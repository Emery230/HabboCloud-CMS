				...
				<div class="page-inner">
					<div id="main-wrapper">
						...
						<div class="row hc_container">
							...
							$Plans = $db->query('SELECT * FROM hc_solutions');
									...
									<section class="hc_box_section">
										<div class="hc_section_card">
											<div class="hc_new_offers_box">
												<h3 class="hc_new_offers_box_title">'.$P['name'].'</h3>
												<p class="hc_paragraphe hc_center_text">'.$P['description'].'</p>
												<ul class="hc_lists_order">
													<li class="'.$this->OptionSolutions($P['option_liste_cms']).'"> Choix du CMS</li>
													<li class="'.$this->OptionSolutions($P['option_liste_emulator']).'"> Choix de l\'émulateur</li>
													<li class="'.$this->OptionSolutions($P['option_support_phone']).'"> Support Téléphonique</li>
													<li class="'.$this->OptionSolutions($P['option_premium_free']).'"> Premium Offert</li>
													<li class="'.$this->OptionSolutions($P['option_full']).'"> Propre VPS, SWF, MySQL</li>
												</ul>
												<center><a href="/Client/Order/Create/'.$P['id'].'" class="btn btn-primary btn-block">Commander</a></center>
											</div>						
										</div>
									</section>
								</div>
