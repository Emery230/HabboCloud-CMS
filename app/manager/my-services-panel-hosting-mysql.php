        ...
        <div class="page-container">
            ...
            <div class="page-content">
				...
				<div class="page-inner">
					<div id="main-wrapper">
						<div class="hc_header">
							<a href="/Client/Services/<?= $fetchID['id']; ?>/Hosting" style="color: #fff"><i class="fa fa-arrow-left "></i> Base de données MySQL</a>		
						</div>
										...
										<ul class="hc_services_ul">
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $Acc['mysql_host']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $Acc['mysql_user']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $Acc['mysql_password']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $Acc['mysql_database']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px">3306</div>										
												</div>
											</li>
										</ul>
									</div>
