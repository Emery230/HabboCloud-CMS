				...
				<div class="page-inner">
					<div id="main-wrapper">
						...
						<div class="row hc_container">
							...
							$New = $db->query('SELECT * FROM hc_new_offers');
							
							$rowCount = $New->rowCount();
							
							if($rowCount == 0) {
								echo 'Aucune nouvelle offre disponible';
							} else {
									...
									<section class="hc_box_section">
										<div class="hc_section_card">
											<div class="hc_new_offers_box">
												<h3 class="hc_new_offers_box_title">'.$N['title'].'</h3>
												<img src="'.$N['banner'].'" style="width: 100%;height: auto>
												<p class="hc_paragraphe hc_center_text">'.$N['description'].'</p>
												<center><a href="'.$N['link'].'" class="btn btn-primary btn-block">En savoir plus</a></center>
											</div>						
										</div>
									</section>
								</div>
