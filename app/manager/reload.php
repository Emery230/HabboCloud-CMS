									...
									<section class="hc_box_section">
										<div class="hc_section_card">
											<div class="hc_new_offers_box">
												<h3 class="hc_new_offers_box_title"><div data-dedipass="11b124515d8f758cb9a1516b5dcaee34" data-dedipass-custom=""><i class="fa fa-spinner fa-pulse"></i> Chargement en cours ...</div></h3>
											</div>						
										</div>
									</section>
								</div>
