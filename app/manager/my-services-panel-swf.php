...
if($rowCountID == 0) {
	...
	$row = $SWF->rowCount();
	if($row = 0) {
		header('Location: /Client/Services/' . $get_id);
	} else {
		$SWFF = $SWF->fetch();
	}
}
        ...
        <div class="page-container">
            ...
            <div class="page-content">
				...
				<div class="page-inner">
					<div id="main-wrapper">
						<div class="hc_header">
							<a href="/Client/Services/<?= $fetchID['id']; ?>" style="color: #fff"><i class="fa fa-arrow-left "></i> Gestion SWF's</a>		
						</div>
										...
										<ul class="hc_services_ul">
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $SWFF['variables']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $SWFF['text']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $SWFF['override_variables']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $SWFF['furnidata']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $SWFF['figuredata']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $SWFF['productdata']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $SWFF['game']; ?></div>										
												</div>
											</li>
											<li class="hc_services_1 hc_services_2 hc_services_3 hc_services_4 hc_services_5 hc_services_6 hc_services_7 hc_services_8 hc_services_9 hc_services_10">
												<div class="col-md-6">
												...
												<div class="col-md-6" style="color: #646e80">
													<div class="pull-right" style="margin-right: 20px"><?= $SWFF['habbo_swf']; ?></div>										
												</div>
											</li>
										</ul>
									</div>
