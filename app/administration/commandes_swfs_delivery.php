...
$Recovery = $db->prepare('SELECT * FROM hc_orders_swfs WHERE id = ?');
$Recovery->execute(array($get_id));
$rowCount = $Recovery->rowCount();

if($rowCount == 0) {
	header('Location: /administration/commandes/swfs');
    exit();
} else {
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="ibox ibox-fullheight">
								<div class="ibox-head">
									<div class="ibox-title">Livraison des SWF's #<?= $fetch['id']; ?></div>
								</div>
								<div class="ibox-body" style="padding: 35px">
									<div class="ibox-fullwidth-block">
										<form id="hc_order_swf">
											<div class="row">
												<div class="col-md-4">
												...
												<div class="col-md-4 form-group">
													...
													<input class="form-control" type="text" name="variables" placeholder="Variables">
													<label>Text</label>
													<input class="form-control" type="text" name="text" placeholder="Text">
													<label>Override Variables</label>
													<input class="form-control" type="text" name="override_variables" placeholder="Override Variables">
													<label>Furnidata</label>
													<input class="form-control" type="text" name="furnidata" placeholder="Furnidata">
												</div>
												<div class="col-md-4 form-group">
													<label>Productdata</label>
													<input class="form-control" type="text" name="productdata" placeholder="Productdata">
													<label>Figuredata</label>
													<input class="form-control" type="text" name="figuredata" placeholder="Figuredata">
													<label>Game</label>
													<input class="form-control" type="text" name="game" placeholder="Game">
                                                    <label>Habbo SWF</label>
													<input class="form-control" type="text" name="habboswf" placeholder="Habbo SWF">
												</div>
												<div class="col-md-12">
													<button class="btn btn-primary btn-block">Livrer</button>
												</div>
											</div>
										</form>
									</div>
