					...
					<div class="row">
						<div class="col-lg-12">
							<div class="ibox ibox-fullheight">
								<div class="ibox-head">
									<div class="ibox-title">Commandes actives</div>
								</div>
								<div class="ibox-body">
									<div class="ibox-fullwidth-block">
										<table class="table table-striped table-hover no-border m-b-0">
											...
											<tbody>
												...
												$Commandes = $db->prepare('SELECT * FROM hc_services WHERE status = ?');
												$Commandes->execute(array('active'));
												...
												while($C = $Commandes->fetch()) {
													echo '<tr>
															...
															<td><a href="/administration/commandes/actives/'.$C['id'].'">Modifier</a></td>
															</tr>';
													}
